...
public class QueryServiceVertxEBProxy implements QueryService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public QueryServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public QueryServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
