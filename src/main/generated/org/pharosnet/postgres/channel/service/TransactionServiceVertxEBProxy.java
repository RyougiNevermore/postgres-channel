...
public class TransactionServiceVertxEBProxy implements TransactionService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public TransactionServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public TransactionServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
